...
public class HelloController {
    ...
    @GetMapping("/greetQR01")
    public ModelAndView QrView01(@RequestParam(name="name", required = false, defaultValue = "World") String name, Model model){
        ModelAndView mav = new ModelAndView("display");
        Developer dev = new Developer(2,"Syed Sufyan Ahmed 02");
        mav.addObject("developer", dev);
        return mav;
    }
}
